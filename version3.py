...
# =================== OCR in Thread =================== #
ocr_running = False  # Flag to prevent multiple OCR runs
...
def run_ocr_async(image_path):
    ...
    try:
        ...
        ocr_running = False  # Allow new OCR after finishing
...
try:
    while True:
        ...
        if stable_count >= STABLE_FRAMES and cooldown == 0 and crop_buffer and not ocr_running:
